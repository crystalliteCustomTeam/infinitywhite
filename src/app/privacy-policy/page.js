    ...
    return (
        <>
            <section className='flex items-center justify-center mt-40 mb-20'>
                <h1 className='text-5xl font-bold text-center font-sans'>Privacy Policies</h1>
            </section>
            <section className=''>
                <div className='container'>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>Do we disclose any information to outside parties?</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>The General Data Protection Regulation Imply</h3>
