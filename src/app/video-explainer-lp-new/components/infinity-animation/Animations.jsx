                ...
                <div className='px-4 sm:px-8 lg:max-w-7xl mx-auto '>
                    <div className="grid grid-cols-12">
                        <div className="col-span-12">
                            ...
                            <p className='text-[#231f20] text-[16px] lg:text-[18px] montserrat font-[400] py-[17px] text-center lg:w-11/12 mx-auto leading-[22px] pb-[60px]'>Our exceptional explainer videos don't just tell stories; they create success stories.</p>
                        </div>
                    </div>
                    <div className='mx-12 bg-[length:100%_100%] bg-center bg-no-repeat bg-[url("../../public/video-explainer2/brand-bg2.png")] py-[50px] px-[20px] rounded-[10px] relative'>
