        ...
        <>
            ...
            <section className=''>
                <div className='container'>
                    ...
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-1'>
                        YOU agree that Infinity Animations is not liable for any correspondence from email address(es) other than the ones followed by our own domain i.e. "..@infinityanimations.com" or/and any toll free number that is not mentioned on our website. Infinity Animations should not be held responsible for any damage(s) caused by such correspondence. We only take responsibility of any communication through email address(es) under our own domain name or/and via toll free number i.e. already mentioned on Infinity Animations Website.
                    </p>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                    ...
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                        ...
                        These terms and conditions form part of the Agreement between the Client and ourselves. Your accessing of this website and/or undertaking of a booking or Agreement indicates your understanding, agreement to and acceptance, of the Disclaimer Notice and the full Terms and Conditions contained herein. Your statutory Consumer Rights are unaffected. © Infinity Animations 2022 All Rights Reserved
                    </p>
