    ...
    return (
        <>
            <section className='flex items-center justify-center mt-40 mb-20'>
                <h1 className='text-5xl font-bold text-center font-sans'>Terms And Conditions</h1>
            </section>
            <section className=''>
                <div className='container'>
                    <h3 className='text-3xl font-bold font-sans mb-3'>Terms And Conditions</h3>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>Privacy Statement</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                        We are committed to protecting your privacy. Authorized employees within the company on a need to know basis only use any information collected from individual customers. We constantly review our systems and data to ensure the best possible service to our customers. Parliament has created specific offences for unauthorised actions against computer systems and data. We will investigate any such actions with a view to prosecuting and/or taking civil proceedings to recover damages against those responsible.
                    </p>
                    <h3 className='text-3xl font-bold font-sans mb-3'>Confidentiality</h3>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>Disclaimer Exclusions and Limitations</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-1'>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>Payment</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>Termination of Agreements and Refunds Policy</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-1'>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>Communication Policy</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-1'>
                        YOU agree that Animation Studioss is not liable for any correspondence from email address(es) other than the ones followed by our own domain i.e. "..@infinityanimations.com" or/and any toll free number that is not mentioned on our website. Animation Studioss should not be held responsible for any damage(s) caused by such correspondence. We only take responsibility of any communication through email address(es) under our own domain name or/and via toll free number i.e. already mentioned on Animation Studioss Website.
                    </p>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>Cookies</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                        Like most interactive web sites this Company's website [or ISP] uses cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site to enable the functionality of this area and ease of use for those people visiting. Some of our affiliate partners may also use cookies.
                    </p>
                    <h3 className='text-3xl font-bold font-sans mb-3'>Links to this website</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-1'>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>Communication</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>Force Majeure</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                    ...
                    <h3 className='text-3xl font-bold font-sans mb-3'>Waiver</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                        Failure of either Party to insist upon strict performance of any provision of this or any Agreement or the failure of either Party to exercise any right or remedy to which it, he or they are entitled hereunder shall not constitute a waiver thereof and shall not cause a diminution of the obligations under this or any Agreement. No waiver of any of the provisions of this or any Agreement shall be effective unless it is expressly stated to be such and signed by both Parties.
                    </p>
                    <h3 className='text-3xl font-bold font-sans mb-3'>General</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-1'>
                        This company is registered in the state of California, United States of America.
                        The laws of California, United States Of America govern these terms and conditions. By accessing this website you consent to these terms and conditions and to the exclusive jurisdiction of the California courts in all disputes arising out of such access. If any of these terms are deemed invalid or unenforceable for any reason (including, but not limited to the exclusions and limitations set out above), then the invalid or unenforceable provision will be severed from these terms and the remaining terms will continue to apply. Failure of the Company to enforce any of the provisions set out in these Terms and Conditions and any Agreement, or failure to exercise any option to terminate, shall not be construed as waiver of such provisions and shall not affect the validity of these Terms and Conditions or of any Agreement or any part thereof, or the right thereafter to enforce each and every provision. These Terms and Conditions shall not be amended, modified, varied or supplemented except in writing and s igned by duly authorised representatives of the Company.
                    </p>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                        Free Animated Logo service will not be applied to any promotional or additional discount / offer.
                    </p>
                    <h3 className='text-3xl font-bold font-sans mb-3'>Notification of Changes</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
                        ...
                        These terms and conditions form part of the Agreement between the Client and ourselves. Your accessing of this website and/or undertaking of a booking or Agreement indicates your understanding, agreement to and acceptance, of the Disclaimer Notice and the full Terms and Conditions contained herein. Your statutory Consumer Rights are unaffected. © Animation Studioss 2022 All Rights Reserved
                    </p>
                    <h3 className='text-3xl font-bold font-sans mb-3'>Third Party Terms of Use</h3>
                    <p className='text-[16px] text-justify font-sans leading-[25px] mb-7'>
