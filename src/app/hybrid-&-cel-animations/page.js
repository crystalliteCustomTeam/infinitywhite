...
export default function Page() {
    ...
    const hero = {
        ...
        para: "Combining Characteristics to Create a Magnificent Animated Video",
        btnBg: "bg-prime",
    };
    //=====Looking Fold=====//
    const paraArray = [
        "When it comes to the tableau of visual storytelling, hybrid animation emerges as a scintillating fusion of traditional and digital artistry, crafting a world where the tactile warmth of hand-drawn characters cavorts with the precision of computer-generated environments. This confluence not only augments the narrative's immersive depth but also imbues it with a unique aesthetic texture, blending the quaint charm of yesteryears' animations with the avant-garde allure of modern technology. ",

        "As such, hybrid animation stands as a testament to the ingenuity of creators, who navigate the conflux of these diverse mediums to weave stories that resonate with a universal audience. Its existence marks a pivotal epoch in the annals of animation."
    ];
    const looking = {
    ...
    const boostContent = [
        {
            ...
            text: "Our Hybrid and Cel animation services will keep your audiences glued to the screen. The mesmeric effect will have them wanting more.",
        },
        {
            icon: boosticon2,
        ...
        },
        {
            ...
            text: "Our Hybrid and Cel animation services are intended for all purposes. They cater to everything and anything related to your business.",
        },
    ];
    const boost = {
        title: (<> The Center of Attention</>),
        para: (<> Hybrid animations are not just creative, they are a potion that triumphs over anything and everything artistic </>),
        btnBg: "bg-prime",
