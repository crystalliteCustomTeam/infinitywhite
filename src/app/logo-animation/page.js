...
export default function Page() {
    ...
    const hero = {
        ...
        para: "A Symbol that Redefines Your Brand’s Image",
        btnBg: "bg-prime",
    };
    //=====Looking Fold=====//
    const paraArray = [
        "Logo animation emerges as a fascinating symphony of motion and design, a visual ballet where brand identities accentuate and leap across the screen. This art form melds the precision of graphic design with the fluidity of animation, transforming static logos into dynamic narratives that breathe life into the essence of a brand. ",

        "Each movement is precisely crafted, a choreographed dance that speaks volumes of a company's ethos and aspirations. The animation of a logo transcends mere aesthetic appeal, embodying a bridge between the brand and its audience, crafting a memorable experience that resonates on a visceral level. It's a confluence of creativity and technology, where every frame serves as a testament to the brand's innovative spirit."
    ];
    const looking = {
    ...
    const boostContent = [
        {
            ...
            text: " Our logo animation services will keep your audiences glued to the screen. The mesmeric effect will have them wanting more.",
        },
        {
            icon: boosticon2,
        ...
        },
        {
            ...
            text: "Our logo animation services are intended for all purposes. They cater to everything and anything related to your business.",
        },
    ];
    const boost = {
        title: (<> The Center of Attention </>),
        para: (<> Logo animations are not just creative, they are a potion that triumphs over anything and everything artistic </>),
        btnBg: "bg-prime",
