...
export default function Page() {
    ...
    const hero = {
        ...
        para: "The Art of Designing and Building Creativity",
        btnBg: "bg-prime",
    };
    //=====Looking Fold=====//
    const paraArray = [
        "When it comes to architectural visualization, where precision marries artistry, one encounters a transcendent form of expression that transcends mere technical prowess. It is a domain where the ethereal visions of architects are transmuted into tangible specters, allowing the beholder to traverse future corridors and linger in spaces yet to be. ",

        "Through a careful alchemy of light, texture, and form, these visualizations serve not merely as blueprints but as a prelude to physical reality, engaging the senses and kindling the imagination. They act as a bridge between the conceptual and the concrete, a canvas upon which the gradations of human interaction with space are anticipated and explored. In this intricate dance of pixels and possibilities, architectural visualization emerges as a profound dialogue between creator and creation."
    ];
    const looking = {
    ...
    const boostContent = [
        {
            ...
            text: "Our architectural visualization services will keep your audiences glued to the screen. The mesmeric effect will have them wanting more.",
        },
        {
            icon: boosticon2,
        ...
        },
        {
            ...
            text: "Our architectural visualization services are intended for all purposes. They cater to everything and anything related to your business.",
        },
    ];
    const boost = {
        title: (<> The Center of Attention </>),
        para: (<> Architectural visualization is not just creative, it is a potion that triumphs over anything and everything artistic </>),
        btnBg: "bg-prime",
