...
export default function Page() {
    ...
    const hero = {
        ...
        para: "We Crop, Snip, Stitch, Animate, and More",
        btnBg: "bg-prime",
    };
    //=====Looking Fold=====//
    const paraArray = [
        "Video editing is an intricate process that demands technical prowess. The editor's discerning eye discerns the minutest imperfections, endeavoring to ensure incessant continuity. Sound design, a harmonious counterpoint, resonates through the visual needlepoint, enriching the viewer's experience. As the climax approaches, pacing becomes paramount, manipulating time to elicit emotional crescendos. This art form is a linguistic expression of emotions, a non-verbal dialogue that transcends boundaries.",

        "In the world of video editing, mastery of the craft is an ongoing odyssey, where innovation merges with tradition, and the language of video editing evolves with every keystroke, etching unforgettable stories onto the screen."
    ];
    const looking = {
        title: (<> Video Editing </>),
        para: { paraArray },
    ...
    const boostContent = [
        {
            ...
            text: "Our video editing services will keep your audiences glued to the screen. The mesmeric effect will have them wanting more.",
        },
        {
            icon: boosticon2,
        ...
        },
        {
            ...
            text: "Our video editing services are intended for all purposes. They cater to everything and anything related to your business.",
        },
    ];
    const boost = {
        title: (<> The Center of Attention </>),
        para: (<> Video editing is not just creative, it is a potion that triumphs over anything and everything artistic </>),
        btnBg: "bg-prime",
