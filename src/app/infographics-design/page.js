...
export default function Page() {
    ...
    const hero = {
        ...
        para: "Visual Representations Intended to Present Information Quickly and Clearly",
        btnBg: "bg-prime",
    };
    //=====Looking Fold=====//
    const paraArray = [
        "Infographics, those vibrant bastions of visual communication, weave together the threads of data and design to fabricate a needlepoint that speaks more eloquently than mere numbers or words ever could alone. This art form, at its zenith, transforms the abstract and arcane into the tangible and understood, enabling a democratization of knowledge. By employing the alchemy of icons, charts, and minimal text, infographics distill complex concepts into digestible, engaging visuals, thus bridging the chasm between the expert and the layperson. ",

        "They not only cater to the voracious appetite of our visually-driven society but also enhance comprehension and retention, making them an indispensable tool in the arsenal of educators, marketers, and journalists alike."
    ];
    const looking = {
        title: (<> Infographics </>),
        para: { paraArray },
    ...
    const boostContent = [
        {
            ...
            text: "Our infographics animation services will keep your audiences glued to the screen. The mesmeric effect will have them wanting more.",
        },
        {
            icon: boosticon2,
        ...
        },
        {
            ...
            text: "Our infographics animation services are intended for all purposes. They cater to everything and anything related to your business.",
        },
    ];
    const boost = {
        title: (<> The Center of Attention </>),
        para: (<> Infographics are not just creative; they are a potion that triumphs over anything and everything artistic </>),
        btnBg: "bg-prime",
