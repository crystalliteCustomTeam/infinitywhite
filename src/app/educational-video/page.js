...
export default function Page() {
    ...
    //=====Looking Fold=====//
    const paraArray = [
        "Animation Studios knows how to convert boring educational material into engaging educational videos by streamlining the concepts and personifying them through educational videos.",
    ...
    const productArray = [
        ...
        "Animation Studios provides educational video marketing through short TikTok videos, a series of quick how-to guides, tutorials, and even complicated full-scale corporate training videos.",
    ];
    const product = {
...
const tabContents = [
    ...
    const portfolio = {
        title: (<> Animation Studios’s Educational Video Production Projects </>),
    ...
    const buzzflick = {
        title: "Why Animation Studios is an Ideal Company for Educational Video Production?",
        para: "Animation Studios stands among the top educational video production companies and has been providing its educational video production services around the globe since 2016.",
