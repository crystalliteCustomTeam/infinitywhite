...
export default function Page() {
    ...
    const hero = {
        ...
        para: "Seize the Endless Essence of Pure Artistry with 2D Animations",
        btnBg: "bg-prime",
    };
    //=====Looking Fold=====//
    const paraArray = [
        "The timeless elegance of 2D animation stands as a testament to the enduring artistry of visual storytelling. With each hand-drawn frame, it molds a stream of emotions and narratives that resonate across generations. The delicate dance of lines and colors breathes life into characters, infusing them with depth and personality. It harkens back to an era when craftsmanship and creativity melded immaculately.",

        "In the hands of skilled animators, 2D animation transcends mere entertainment, becoming a vessel for profound expression. It captures the essence of human emotion, from the subtlest of gestures to the grandest of adventures. Through the lens of this timeless art form, we are transported to worlds both whimsical and profound."
    ];
    const looking = {
        title: (<> 2D Animation </>),
        para: { paraArray },
    ...
    const boostContent = [
        {
            ...
            text: "Our 2D animations will keep your audiences glued to the screen. The mesmeric effect will have them wanting more.",
        },
        {
            icon: boosticon2,
        ...
        },
        {
            ...
            text: "Our 2D animations are intended for all purposes. They cater to everything and anything related to your business.",
        },
    ];
    const boost = {
        title: (<> The Center of Attention </>),
        para: (<> 2D animation is not just creative, it is a potion that triumphs over anything and everything artistic </>),
        btnBg: "bg-prime",
