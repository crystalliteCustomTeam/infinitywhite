...
//===== Images 
import ButtonIcon from 'media/icons/arrow-r.png'
                                ...
                                <div className="col-span-12 md:col-span-6">
                                    <div className="px-4 md:px-4 lg:px-8 py-[20px] md:py-[30px] lg:py-[40px] xl:py-[60px] 2xl:py-[76px]">
                                        ...
                                        <form action="javascript:;" className='flex items-center'>
                                            ...
                                            <button type='submit' className='bg-white rounded-r-[5px] text-[18px] text-[#FB1F32] font-sans h-[50px] w-[160px] flex items-center justify-center gap-2 lg:gap-2'>
                                                Subscribe
